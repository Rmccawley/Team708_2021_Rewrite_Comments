...
public final class Constants {
  ...
  public static final class SpinnerConstants {
    ...
    public static final double kSPIN_ONE_COLOR = 3.0;
    public static final double kSPIN_THREE_TIMES = 60.0;
  ...
  public static final class ShooterConstants {
    ...
    public static final double kSHOOTER_WHEELSPEED_LONG = 3900.0;
    public static final double kSHOOTER_WHEELSPEED_SHORT = 1850.0;
  ...
  public static final class TurretConstants {
    ...
    public static final int TURRET_ENCODER_COUNT = 32768;
    public static final double TURRET_ENCODER_STARTING_POS = -2614;

    public static final double TURRET_ROTATION_MAX_SPEED = 9625;
