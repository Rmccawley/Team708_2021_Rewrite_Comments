...
public class Spinner extends SubsystemBase {
    ...
    public void spinnerRotateOneColor() {
        pistonExtend();
        resetSpinnerEncoder();
        spinnerPID.setReference(-SpinnerConstants.kSPIN_ONE_COLOR, ControlType.kPosition);
    }

    public void spinnerRotateThreeTimes() {
        pistonExtend();
        resetSpinnerEncoder();
        spinnerPID.setReference(-SpinnerConstants.kSPIN_THREE_TIMES, ControlType.kPosition);
    }
